...
The executable [Savepoint Upgrade and Rescaling Lab](../../concepts/flink/state/savepoint-upgrade.md) proves this flow locally with a canonical savepoint and a parallelism change from one to two.
